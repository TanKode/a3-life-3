...
schiffsw_loot_array =	[
	                            ["turtle", floor(random 35)+15], //1,5 M 
                                ["goldbar", floor(random 15)+5], //2,5 N
                                ["schmuck", floor(random 100)+25] //1,75 M
						];
schiffsw_fixed_loot_array =	[
								["coffee", floor(random 10)],
								["donuts", floor(random 10)],
								["fuelF", floor(random 5)],
								["boltcutter", floor(random 2)],
                                ["tracker", floor(random 2)],
								["storagesmall", floor(random 1)],
								["storagebig", floor(random 1)]
							];
...
// schiffsw STARTEN
[[5,"<t size='1.4'><t color='#A5DF00'>SCHIFFSWRACK</t></t><br/><br/><t size='1'>Ein Schiff mit wichtigen Sachen ist gesunken und ist jetzt auf deiner Karte makiert!</t>"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
...
[[5,"<t size='1.4'><t color='#A5DF00'>SCHIFFSWRACK</t></t><br/><br/><t size='1'>Das Schiff wurde gesprengt und ist jetzt offen!</t>"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
...
[[5,"<t size='1.4'><t color='#A5DF00'>SCHIFFSWRACK</t></t><br/><br/><t size='1'>Das Schiff ist einfach verschwunden!</t>"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;