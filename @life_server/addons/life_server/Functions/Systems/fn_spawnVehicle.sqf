...
_illegalItems = ["put","your","virtual","items","shortnames","here"];
_unit_return = _unit;
_name = name _unit;
_side = side _unit;
_unit = owner _unit;
...
if((_vInfo select 1) == "med" && (_vInfo select 2) in ["C_Offroad_01_F","B_MRAP_01_F","C_SUV_01_F","I_MRAP_03_F","I_Heli_light_03_unarmed_F","C_Hatchback_01_sport_F","C_Hatchback_01_F","B_Heli_Light_01_F"]) then
{
