...
compileFinal "
	...
	[[life_RLP_atmgeld,life_RLP_handgeld,owner player,player],""life_fnc_admininfo"",_ret,false] spawn life_fnc_MP;
";
...
compileFinal "
	...
	[[_msg,name player,3],""TON_fnc_clientMessage"",true,false] spawn life_fnc_MP;
	[] call life_fnc_cellphone;
...
private[""_msg"",""_to""];
	...
	[[_msg,name player,4],""TON_fnc_clientMessage"",east,false] spawn life_fnc_MP;
	[] call life_fnc_cellphone;
...
compileFinal "
   ...
   [[_msg,name player,5,player],""TON_fnc_clientMessage"",true,false] call life_fnc_MP;
   [] call life_fnc_cellphone;
...
compileFinal "
	...
	switch (_type) do
	{
        ...
        case 5 :
        {
           ...
           hint parseText format [""<t color='#FF0000'><t size='2'><t align='center'>Polizei Meldung<br/><br/><t color='#33CC33'><t align='left'><t size='1'>An: <t color='#ffffff'>Alle Spieler<br/><t color='#33CC33'>Von: <t color='#ffffff'>APD<br/><br/><t color='#33CC33'>Nachricht:<br/><t color='#ffffff'>%1"",_msg];
