...
if(life_RLP_atmgeld < _price && life_RLP_handgeld < _price) exitWith {hint format[(localize "STR_Garage_CashError"),[_price] call life_fnc_numberText];};
...
if(life_RLP_atmgeld >= _price) then
{
