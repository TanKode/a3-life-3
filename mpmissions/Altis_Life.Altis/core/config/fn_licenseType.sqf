...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			case "sec": {_var = "license_cop_sec"}; //Security License
			...
			case "tf": {_var = "license_cop_tf"}; //task force
            ...
            case "mohawk": {_var = "license_med_mohawk"};
            ...
            case "datennsa": {_var = "license_civ_datennsa"};
	...
	case 1:
	{
		switch (_type) do
		{
            ...
            case "license_civ_huntung": {_var = "hunting"};
            case "license_med_mohawk": {_var = "mohawk"};
            case "license_civ_krabben": {_var = "krabben"};
            case "license_civ_grab": {_var = "grab"};
            case "license_civ_reli": {_var = "reli"};
            case "license_civ_gas": {_var = "gas"};
            case "license_civ_gold": {_var = "gold"};
            case "license_civ_knochen": {_var = "knochen"};
            case "license_civ_pfandflasche": {_var = "pfandflasche"};
            case "license_civ_daten": {_var = "daten"};
            case "license_civ_datennsa": {_var = "datennsa"};
