			...
			default
			{
				["Donator Fundgrube",
					[
						...
						["30Rnd_mas_9x21_Stanag",nil,3500],
						["hgun_mas_sa61_F",nil,38500],
						["20Rnd_mas_765x17_Mag",nil,3850],["arifle_Katiba_F",nil,84000],
		...
		switch(true) do
		{
			...
			default
			{
				["Billy Joe's Waffenladen",
					[
						["hgun_ACPC_F",nil,20000],["9Rnd_45ACP_Mag",nil,200],
