	...
	case "donator_legal":
	{
		switch(true) do
		{
			...
			default
			{
				["Donator Fundgrube",
					[
						["hgun_P07_F","P07 9 mm",17500],
						["16Rnd_9x21_Mag","P07 9mm Mag",1750],
						["hgun_Pistol_heavy_01_F","4-five .45",21000],
						["11Rnd_45ACP_Mag","4-five Mag",2100],
						["hgun_PDW2000_F","PDW2000 9 mm",21000],
						["30Rnd_9x21_Mag","PDW Mag",2100],
						["hgun_mas_glock_F","Glock17",24500],
						["17Rnd_mas_9x21_Mag","Glock17 Mag",2450],
						["hgun_mas_m9_F","M9",24500],
						["15Rnd_mas_9x21_Mag","M9 Mag",2450],
						["SMG_01_F","Vermin SMG .45 ACP",40000],
						["30Rnd_45ACP_Mag_SMG_01","Vermin Mag",2800],
						["SMG_02_F","Sting 9 mm",28000],
						["30Rnd_9x12_Mag","Sting Mag",3150],
						["arifle_SDAR_F","SDAR 5.56 mm",35000],
						["20Rnd_556x45_UW_mag","SDAR Mag",3500],
						["arifle_TRG21_F","TRG-20 5.56 mm",38500],
						["30Rnd_556x45_Stanag","TRG21 Mag",3850],
						["optic_Yorris","Yorris J2",3500],
						["optic_MRD","optic_MRD",3500],
						["optic_Aco","ACO",3500],
						["optic_Holosight","Holosight",3500]
					]
				];
			};
		};
	...
	case "donator_illegal":
	{
		switch(true) do
		{
			...
			default
			{
				["Donator Fundgrube",
					[
						["arifle_MK20_plain_F","MK20",63000],
						["30Rnd_556x45_Stanag","MK20 Mag",6300],
						["hgun_mas_uzi_F","Uzi",35000],
						["30Rnd_mas_9x21_Stanag"," Uzi Mag",3500],
						["hgun_mas_sa61_F","Skorpion",38500],
						["20Rnd_mas_765x17_Mag","Skorpion Mag",3850],
						["arifle_Katiba_F","Katiba",84000],
						["30Rnd_65x39_caseless_green","Katiba Mag",8400],
						["arifle_mas_l119","L119A1",105000],
						["30Rnd_556x45_Stanag","L119A1 Mag",10500],
						["hlc_rifle_auga3","AUG A3",105000],
						["hlc_30Rnd_556x45_B_AUG","AUG A3 Mag",10500],
						["arifle_MXC_F","MXC",112000],
						["30Rnd_65x39_caseless_mag","MXC Mag",11200],
						["arifle_mx_F","MX",119000],
						["30Rnd_65x39_caseless_mag","MX Mag",11900],
						["arifle_mas_bizon","Bizon",126000],
						["64Rnd_mas_9x18_mag","Bizon Mag",12600],
						["hlc_rifle_Bushmaster300","Bushmaster",140000],
						["29rnd_300BLK_STANAG","Bushmaster Mag",14000],
						["srifle_DMR_01_F","Rahim",154000],
						["10Rnd_762x54_Mag","Rahim Mag",15400],
						["optic_Hamr","RCO",3500],
						["optic_Arco","ARCO",3500],
						["optic_Holosight","Holosight",3500],
						["optic_Aco","ACO",3500],
						["optic_ACO_grn","ACO Grün",3500],
						["optic_MRCO","MRCO",3500],
						["optic_SOS","SOS",3500],
						["optic_DMS","DMS",3500],
						["optic_mas_zeiss","Zeiss",3500],
						["optic_mas_zeiss_eo","Zeiss Holo",3500],
						["optic_mas_DMS","Leupold",3500],
						["optic_mas_acog","Acog",3500],
						["optic_mas_acog_eo","Acog Holo",3500],
						["optic_mas_handle","M4 Handle",3500],
						["optic_mas_aim","Aimpoint",3500],
						["optic_mas_pso","PSO",3500],
						["optic_mas_pso_eo","PSO Holo",3500],
						["optic_mas_pso_nv","PSO Sniper",3500],
						["optic_AMS","AMS",3500],
						["optic_KHS_blk","Kahlia Black",3500],
						["bipod_01_F_snd","Zweibein Sand",10500],
						["bipod_01_F_blk","Zweibein Schw.",10500],
						["bipod_01_F_mtp","Zweibein MTP",10500],
						["bipod_02_F_blk","Zweibein Schw, CSAT",10500],
						["bipod_02_F_tan","Zweibein Tan CSAT",10500],
						["bipod_02_F_hex","Zweibein Hex CSAT",10500],
						["bipod_03_F_blk","Zweibein Black AAF",10500],
						["bipod_03_F_oli","Zweibein Olive AAF",10500]
					]
				];
			};
		};
	...
	case "donator_bm":
	{
		switch(true) do
		{
			...
			default
			{
				["Donator Fundgrube",
					[
						["hgun_Pistol_heavy_02_F","Zudr. 45",52500],
						["6Rnd_45ACP_Cylinder","Zubr. Mag",5250],
						["arifle_mas_m1014","Benelli",105000],
						["7Rnd_mas_12Gauge_Pellets","Benelli Mag",10500],
						["arifle_MXM_F","MXM",129500],
						["30Rnd_65x39_caseless_mag","MXM Mag",12950],
						["arifle_mas_akm","AKM",154000],
						["30Rnd_mas_762x39_mag","AKM Mag",15400],
						["hlc_rifle_bcmjack","Jack Carabine",196000],
						["hlc_30rnd_556x45_EPR","Jack Carabine Mag",19600],
						["srifle_mas_m110","M110",210000],
						["20Rnd_762x51_Mag","M110 Mag",21000],
						["srifle_EBR_F","Mk18",210000],
						["20Rnd_762x51_Mag","MK18 Mag",21000],
						["srifle_mas_sr25","SR25",224000],
						["20Rnd_762x51_Mag","SR25 Mag",22400],
						["hlc_rifle_psg1","PSG-1",245000],
						["hlc_20rnd_762x51_b_G3","PSG-1 Mag",24500],
						["srifle_DMR_03_F","MK-1 EMR",280000],
						["20Rnd_762x51_Mag","MK-1 EMR Mag",28000],
						["arifle_mas_mk17","SCAR-H",294000],
						["20Rnd_762x51_Mag","SCAR-H Mag",29400],
						["srifle_mas_svd","SVD Dragunov",315000],
						["10Rnd_mas_762x54_mag","Dragunov Mag",31500],
						["acc_pointer_IR","Laiserpointer",7000],
						["acc_flashlight","Taschenlampe",7000],
						["optic_Hamr","RCO",3500],
						["optic_Arco","ARCO",3500],
						["optic_Holosight","Holosight",3500],
						["optic_Aco","ACO",3500],
						...
						["optic_AMS","AMS",3500],
						["optic_KHS_blk","Kahlia Black",3500],
						["muzzle_snds_H","Schalldämpfer 6.5mm",24500],
						["muzzle_snds_L","Schalldämpfer 9mm",24500],
						["muzzle_snds_M","Schalldämpfer 5.56mm",24500],
						["muzzle_snds_B","Schalldämpfer 7.62mm",24500],
						["muzzle_mas_snds_SM","Schalldämpfer m4, m16, HK",24500],
						["muzzle_mas_snds_SH","Schalldämpfer M24",24500],
						["hlc_muzzle_556nato_KAC","Schalldämpfer Jack C.",24500],
						["bipod_01_F_snd","Zweibein Sand",10500],
						["bipod_01_F_blk","Zweibein Schw.",10500],
						["bipod_01_F_mtp","Zweibein MTP",10500],
						["bipod_02_F_blk","Zweibein Schw, CSAT",10500],
						...
						["bipod_03_F_blk","Zweibein Black AAF",10500],
						["bipod_03_F_oli","Zweibein Olive AAF",10500],
						["HandGrenade_Stone","Blendgranate",2000000]
					]
				];
			};
		};
