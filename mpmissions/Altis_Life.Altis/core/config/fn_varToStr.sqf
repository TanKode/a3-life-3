...
//Virtual Inventory Items
	...
	case "life_inv_laufc": {"Sniperlauf"};
	case "life_inv_laufd": {"MG-Lauf"};
	case "life_inv_griff": {"Griffstück"};
	case "life_inv_magazina": {"kleines Magazin"};
	case "life_inv_magazinb": {"großes Magazin"};
	case "life_inv_feder": {"Schliessfeder"};
	case "life_inv_gasantrieb": {"Gasantrieb"};
	case "life_inv_gaskolben": {"Gaskolben"};
	case "life_inv_antrieb": {"Antriebsstange"};
	case "life_inv_abnahme": {"Gasabnahme"};
    ...
    case "life_inv_uwsl": {"Unterwasserbombe"};
    case "life_inv_krabben": {"Frische Krabben"};
    case "life_inv_krabbenv": {"Geschaelte Krabben"};
    case "life_inv_grabv": {"Saubere Grabbeilagen"};
    case "life_inv_grab": {"Dreckige Grabbeilagen"};
    case "life_inv_reli": {"Dreckige Relikte"};
    case "life_inv_reliv": {"Saubere Relikte"};
	...
	case "license_cop_tf": {"Task Force Mitgliedschaft"};	
	case "license_civ_sec": {"Secrurity Mitgliedschaft"};
	...
	case "license_civ_taxi": {"Taxiführerschein"};
	case "license_adac_car": {"ADAC Führerschein"};
    case "license_adac_air": {"ADAC Pilotenschein"};
    case "license_civ_hunting": {"Jagdschein"};
    case "license_med_mohawk": {"Mohawkschein"};
    case "license_civ_krabben": {"Krabbenschein"};
    ...
    case "license_civ_datennsa": {"NSA_DatenLizenz"};
    ...
    case "license_civ_uranuwe": {"UranSchrottLizenz"};
	...
	case "Wein_Prof": {(localize "STR_Prof_Wein")}; 
	case "Zucker_Prof": {(localize "STR_Prof_Zucker")};
	case "Getreide_Prof": {(localize "STR_Prof_Getreide")};
	case "Bier_Prof": {(localize "STR_Prof_Bier")};
