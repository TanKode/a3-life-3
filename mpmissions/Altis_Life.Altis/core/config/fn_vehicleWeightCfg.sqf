...
switch (_className) do
{
	...
	case "O_Heli_Light_02_unarmed_F": {165}; // PO-30 Orca (Unarmed)
	case "ARMSCor_A109_Civ": {275}; // A109 (Unarmed)
	case "I_Heli_light_03_unarmed_F": {65}; // WY-55 Hellcat (Green)
	...
	case "O_Truck_02_covered_F": {400}; //Zamak Transport (abgedeckt)
	...
	case "B_Truck_01_transport_F": {1000}; //HEMTT Transport
