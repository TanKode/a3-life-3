...
if(life_RLP_atmgeld < (__GETC__(life_gangPrice))) exitWith {hint format[localize "STR_GNOTF_NotEnoughMoney",[((__GETC__(life_gangPrice))-life_RLP_atmgeld)] call life_fnc_numberText];};
