...
if(life_RLP_handgeld < life_ticket_val) exitWith
{
	if(life_RLP_atmgeld < life_ticket_val) exitWith
	{
	...
	life_RLP_atmgeld = life_RLP_atmgeld - life_ticket_val;
...
life_RLP_handgeld = life_RLP_handgeld - life_ticket_val;
life_ticket_paid = true;
