...
if(life_RLP_handgeld < _basePrice) exitWith {hint format[localize "STR_Shop_Veh_NotEnough",[_basePrice - life_RLP_handgeld] call life_fnc_numberText];};
...
life_RLP_handgeld = life_RLP_handgeld - _basePrice;
