...
if(toLower(_functionName) in ["bis_fnc_endmission","bis_fnc_endmissionserver","endmission","failmission","playmission","hostmission"]) exitWith {false}; //Don't allow BIS_fnc_endMission to be passed.
