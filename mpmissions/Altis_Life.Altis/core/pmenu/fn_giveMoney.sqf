...
if(parseNumber(_amount) > life_RLP_handgeld) exitWith {hint "D uhast nicht so viel geld!";ctrlShow[2001,true];};
if(isNull _unit) exitWith {ctrlShow[2001,true];};
...
life_RLP_handgeld = life_RLP_handgeld - (parseNumber(_amount));
[0] call SOCK_fnc_updatePartial;
[[_unit,_amount,player],"life_fnc_receiveMoney",_unit,false] spawn life_fnc_MP;
[[player, _unit, _amount, 1, life_RLP_atmgeld, life_RLP_handgeld],"TON_fnc_handleDBLog",false] spawn life_fnc_MP;
